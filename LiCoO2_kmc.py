...
dimensions = [35]  # loop over this
simulation_iterations = 500  # how many steps
presimulation_iterations = 0  # how many pre simulation steps
# np.array(range(10,100,2))/100. # looping over these too
concentrations = [0.85]
average_path_counts = []
    ...
    for Li_concentration in concentrations:
        ...
        while averageing_iteration <= averaging_iterations:
            ...
            while simulation < simulation_iterations:  # how many kmc steps to take
                ...
                colorsquare(np.transpose(mc_lattice)[
                            0], "lattice_pictures/" + str(simulation + 10) + ".png")
